...
class TestProviderInterfaceContracts:
    ...
    def test_data_provider_abstract_methods(self):
        ...
        expected_methods = {
            'connect', 'subscribe_trades', 'subscribe_events',
            'iter_ticks', 'iter_events', 'disconnect'
        }
    ...
    def test_trade_provider_abstract_methods(self):
        ...
        expected_methods = {
            'submit_order', 'close_position', 'fetch_positions',
            'get_account_equity', 'connect', 'disconnect'
        }
