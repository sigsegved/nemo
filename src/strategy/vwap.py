...
class VWAPCalculator:
    ...
    def calculate_vwap(self, as_of_time: Optional[datetime] = None) -> Optional[Decimal]:
        """
        ...
        if (self._cache_valid and self._cached_timestamp == as_of_time 
...
class VolumeAggregator:
    ...
    def get_average_volume(self, periods: int = 10, as_of_time: Optional[datetime] = None) -> Optional[Decimal]:
        """
