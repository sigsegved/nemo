...
class ProviderFactory:
    ...
    @classmethod
    def register_data_provider(cls, name: str, provider_class: Type[DataProvider]) -> None:
        """Register a data provider implementation."""
        cls._data_providers[name] = provider_class
    
    @classmethod
    def register_trade_provider(cls, name: str, provider_class: Type[TradeProvider]) -> None:
        """Register a trading provider implementation."""
        cls._trade_providers[name] = provider_class
    
    @classmethod
    def create_data_provider(cls, provider_name: str, config: Dict[str, Any]) -> DataProvider:
    ...
    @classmethod
    def create_trade_provider(cls, provider_name: str, config: Dict[str, Any]) -> TradeProvider:
